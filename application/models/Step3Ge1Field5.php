<?php
/**
* Class Model for ges_1_5 table
*/
class Model_Step3Ge1Field5 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'ges_1_5';	
	protected $_primary = 'id';
	
	protected $_dependentTables = array('Model_Step3Ge1');
	
	/**
	 * [createStep3Ge1Field5 create a new row in the ges_1_5 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep3Ge1Field5($id)
	{
