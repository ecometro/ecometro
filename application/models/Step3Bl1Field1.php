<?php
/**
* Class Model for bls_1_1 table
*/
class Model_Step3Bl1Field1 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'bls_1_1';	
	protected $_primary = 'id';
	
	protected $_dependentTables = array('Model_Step3Bl1');

	/**
	 * [createStep3Bl1Field1 create a new row in the bls_1_1 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep3Bl1Field1($id)
	{
