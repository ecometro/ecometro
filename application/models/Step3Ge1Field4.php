<?php
/**
* Class Model for ges_1_4 table
*/
class Model_Step3Ge1Field4 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'ges_1_4';	
	protected $_primary = 'id';
	
	protected $_dependentTables = array('Model_Step3Ge1');

	/**
	 * [createStep3Ge1Field4 create a new row in the ges_1_4 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep3Ge1Field4($id)
	{
