<?php
/**
* Class Model for mps_15_1 table
*/
class Model_Step2Mp15Field1 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'mps_15_1';	
	protected $_primary = 'id';	
	protected $_dependentTables = array('Model_Step2Mp15');
		
	/**
	 * [createStep2Mp15Field1 create a new row in the mps_15_1 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep2Mp15Field1($id)
	{
