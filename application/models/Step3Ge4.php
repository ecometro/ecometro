<?php
/**
* Class Model for s_3_ges_4 table
*/
class Model_Step3Ge4 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 's_3_ges_4';	
	protected $_primary = 'id';
	
	protected $_dependentTables = array('Model_Step3');
	
	protected $_referenceMap = array(
		'Step3Ge4Field1' => array(
			'columns' => array('ge_4_1_id'),
			'refTableClass' => 'Model_Step3Ge4Field1'
	 	)
	);

	/**
	 * [createStep3Ge4 create a new row in the s_3_ges_4 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep3Ge4($id)
	{
	...
	/**
	 * [updateStep3Ge4 update table s_3_ges_4's row]
	 * @param  [type] $id        [description]
	 * @param  [type] $idStep3Ge [description]
	 * @param  [type] $count     [description]
	 * @return [type]            [description]
	 */
	public function updateStep3Ge4($id, $idStep3Ge, $count)
	{
	...
	/**
	 * [findFieldbyGe4Id find field number by s_3_ges_4's id]
	 * @param  [type] $ge4Id [description]
	 * @param  [type] $count [description]
	 * @return [type]        [description]
	 */
	public function findFieldbyGe4Id($ge4Id, $count)
	{
		$result = $ge4Id->findParentRow('Model_Step3Ge4Field' . $count);
