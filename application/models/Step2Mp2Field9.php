<?php
/**
* Class Model for mps_2_9 table
*/
class Model_Step2Mp2Field9 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'mps_2_9';	
	protected $_primary = 'id';	
	protected $_dependentTables = array('Model_Step2Mp2');
	
	/**
	 * [createStep2Mp2Field9 create a new row in the mps_2_9 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep2Mp2Field9($id)
	{
