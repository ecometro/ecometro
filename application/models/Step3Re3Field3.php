<?php
/**
* Class Model for res_3_3 table
*/
class Model_Step3Re3Field3 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'res_3_3';	
	protected $_primary = 'id';
	
	protected $_dependentTables = array('Model_Step3Re3');
	
	/**
	 * [createStep3Re3Field3 create a new row in the res_3_3 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep3Re3Field3($id)
	{
