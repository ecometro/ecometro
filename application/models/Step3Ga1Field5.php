<?php
/**
* Class Model for gas_1_5 table
*/
class Model_Step3Ga1Field5 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'gas_1_5';	
	protected $_primary = 'id';
	
	protected $_dependentTables = array('Model_Step3Ga1');

	/**
	 * [createStep3Ga1Field5 create a new row in the gas_1_5 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep3Ga1Field5($id)
	{
