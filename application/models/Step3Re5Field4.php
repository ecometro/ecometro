<?php
/**
* Class Model for res_5_4 table
*/
class Model_Step3Re5Field4 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'res_5_4';	
	protected $_primary = 'id';
	
	protected $_dependentTables = array('Model_Step3Re5');

	/**
	 * [createStep3Re5Field4 create a new row in the res_5_4 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep3Re5Field4($id)
	{
