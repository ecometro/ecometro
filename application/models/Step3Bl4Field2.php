<?php
/**
* Class Model for bls_4_2 table
*/
class Model_Step3Bl4Field2 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'bls_4_2';	
	protected $_primary = 'id';
	
	protected $_dependentTables = array('Model_Step3Bl4');

	/**
	 * [createStep3Bl4Field2 create a new row in the bls_4_2 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep3Bl4Field2($id)
	{
