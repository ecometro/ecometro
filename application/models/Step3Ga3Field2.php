<?php
/**
* Class Model for gas_3_2 table
*/
class Model_Step3Ga3Field2 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'gas_3_2';	
	protected $_primary = 'id';
	
	protected $_dependentTables = array('Model_Step3Ga3');

	/**
	 * [createStep3Ga3Field2 create a new row in the gas_3_2 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep3Ga3Field2($id)
	{
