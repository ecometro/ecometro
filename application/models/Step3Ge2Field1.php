<?php
/**
* Class Model for ges_2_1 table
*/
class Model_Step3Ge2Field1 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'ges_2_1';	
	protected $_primary = 'id';
	
	protected $_dependentTables = array('Model_Step3Ge2');

	/**
	 * [createStep3Ge2Field1 create a new row in the ges_2_1 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep3Ge2Field1($id)
	{
