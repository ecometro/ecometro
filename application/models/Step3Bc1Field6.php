<?php
/**
* Class Model for bcs_1_6 table
*/
class Model_Step3Bc1Field6 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'bcs_1_6';	
	protected $_primary = 'id';
	
	protected $_dependentTables = array('Model_Step3Bc1');
	
	/**
	 * [createStep3Bc1Field6 create a new row in the bcs_1_6 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep3Bc1Field6($id)
	{
