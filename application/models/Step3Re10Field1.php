<?php
/**
* Class Model for res_10_1 table
*/
class Model_Step3Re10Field1 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'res_10_1';	
	protected $_primary = 'id';	
	protected $_dependentTables = array('Model_Step3Re10');

	/**
	 * [createStep3Re10Field1 create a new row in the res_10_1 table]
	 * @param  [type] $id [description]
	 * @return [type] $id [description]
	 */
	public function createStep3Re10Field1($id)
	{
