<?php
/**
* Class Model for res_5_5 table
*/
class Model_Step3Re5Field5 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'res_5_5';	
	protected $_primary = 'id';
	
	protected $_dependentTables = array('Model_Step3Re5');

	/**
	 * [createStep3Re5Field5 create a new row in the res_5_5 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep3Re5Field5($id)
	{
