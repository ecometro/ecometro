<?php
/**
* Class Model for mps_1_4 table
*/
class Model_Step2Mp1Field4 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'mps_1_4';	
	protected $_primary = 'id';	
	protected $_dependentTables = array('Model_Step2Mp1');
		
	/**
	 * [createStep2Mp1Field4 create a new row in the mps_1_4 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep2Mp1Field4($id)
	{
