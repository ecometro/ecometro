<?php
/**
* Class Model for res_4_1 table
*/
class Model_Step3Re4Field1 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'res_4_1';	
	protected $_primary = 'id';
	
	protected $_dependentTables = array('Model_Step3Re4');

	/**
	 * [createStep3Re4Field1 create a new row in the res_4_1 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep3Re4Field1($id)
	{
