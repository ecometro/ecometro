<?php
/**
* Class Model for mps_13_2 table
*/
class Model_Step2Mp13Field2 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'mps_13_2';	
	protected $_primary = 'id';	
	protected $_dependentTables = array('Model_Step2Mp13');
		
	/**
	 * [createStep2Mp13Field2 create a new row in the mps_13_2 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep2Mp13Field2($id)
	{
