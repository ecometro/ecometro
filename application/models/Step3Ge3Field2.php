<?php
/**
* Class Model for ges_3_2 table
*/
class Model_Step3Ge3Field2 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'ges_3_2';	
	protected $_primary = 'id';
	
	protected $_dependentTables = array('Model_Step3Ge3');

	/**
	 * [createStep3Ge3Field2 create a new row in the ges_3_2 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep3Ge3Field2($id)
	{
