<?php
/**
* Class Model for mps_7_3 table
*/
class Model_Step2Mp7Field3 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'mps_7_3';	
	protected $_primary = 'id';	
	
	protected $_dependentTables = array('Model_Step2Mp7');
	
	/**
	 * [createStep2Mp7Field3 create a new row in the mps_7_3 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep2Mp7Field3($id)
	{
