<?php
/**
* Class Model for bls_3_4 table
*/
class Model_Step3Bl3Field4 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'bls_3_4';	
	protected $_primary = 'id';
	
	protected $_dependentTables = array('Model_Step3Bl3');

	/**
	 * [createStep3Bl3Field4 create a new row in the bls_3_4 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep3Bl3Field4($id)
	{
