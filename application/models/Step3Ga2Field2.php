<?php
/**
* Class Model for gas_2_2 table
*/
class Model_Step3Ga2Field2 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'gas_2_2';	
	protected $_primary = 'id';
	
	protected $_dependentTables = array('Model_Step3Ga2');

	/**
	 * [createStep3Ga2Field2 create a new row in the gas_2_2 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep3Ga2Field2($id)
	{
