<?php
/**
* Class Model for bls_5_2 table
*/
class Model_Step3Bl5Field2 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'bls_5_2';	
	protected $_primary = 'id';
	
	protected $_dependentTables = array('Model_Step3Bl5');

	/**
	 * [createStep3Bl5Field2 create a new row in the bls_5_2 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep3Bl5Field2($id)
	{
