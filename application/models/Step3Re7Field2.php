<?php
/**
* Class Model for res_7_2 table
*/
class Model_Step3Re7Field2 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'res_7_2';	
	protected $_primary = 'id';		
	protected $_dependentTables = array('Model_Step3Re7');
	
	/**
	 * [createStep3Re7Field2 create a new row in the res_7_2 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep3Re7Field2($id)
	{
