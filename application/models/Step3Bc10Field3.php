<?php
/**
* Class Model for bcs_10_3 table
*/
class Model_Step3Bc10Field3 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'bcs_10_3';	
	protected $_primary = 'id';
	
	protected $_dependentTables = array('Model_Step3Bc10');
	
	/**
	 * [createStep3Bc10Field3 create a new row in the bcs_10_3 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep3Bc10Field3($id)
	{
