<?php
/**
* Class Model for mps_5_5 table
*/
class Model_Step2Mp5Field5 extends Zend_Db_Table_Abstract{
	
	protected $_name = 'mps_5_5';	
	protected $_primary = 'id';		
	protected $_dependentTables = array('Model_Step2Mp5');
	
	/**
	 * [createStep2Mp5Field5 create a new row in the mps_5_5 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep2Mp5Field5($id)
	{
