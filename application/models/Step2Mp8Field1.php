<?php
/**
* Class Model for mps_8_1 table
*/
class Model_Step2Mp8Field1 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'mps_8_1';	
	protected $_primary = 'id';	
	
	protected $_dependentTables = array('Model_Step2Mp8');
	
	/**
	 * [createStep2Mp8Field1 create a new row in the mps_8_1 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep2Mp8Field1($id)
	{
