...
*/
class Model_Step3Ge4Field1 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'ges_4_1';	
	protected $_primary = 'id';
	
	protected $_dependentTables = array('Model_Step3Ge4');

	/**
	 * [createStep3Ge4Field1 create a new row in the ges_4_1 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep3Ge4Field1($id)
	{
