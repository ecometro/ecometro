<?php
/**
* Class Model for mps_16_2 table
*/
class Model_Step2Mp16Field2 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'mps_16_2';	
	protected $_primary = 'id';		
	protected $_dependentTables = array('Model_Step2Mp16');
		
	/**
	 * [createStep2Mp16Field2 create a new row in the mps_16_2 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep2Mp16Field2($id)
	{
