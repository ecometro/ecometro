<?php
/**
* Class Model for bcs_4_6 table
*/
class Model_Step3Bc4Field6 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'bcs_4_6';	
	protected $_primary = 'id';
	
	protected $_dependentTables = array('Model_Step3Bc4');

	/**
	 * [createStep3Bc4Field6 create a new row in the bcs_4_6 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep3Bc4Field6($id)
	{
