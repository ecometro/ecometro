<?php
/**
* Class Model for res_11_1 table
*/
class Model_Step3Re11Field1 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'res_11_1';	
	protected $_primary = 'id';
	
	protected $_dependentTables = array('Model_Step3Re11');
	
	/**
	 * [createStep3Re11Field1 create a new row in the res_11_1 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep3Re11Field1($id)
	{
