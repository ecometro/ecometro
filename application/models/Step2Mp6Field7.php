<?php
/**
* Class Model for mps_6_7 table
*/
class Model_Step2Mp6Field7 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'mps_6_7';	
	protected $_primary = 'id';	
	
	protected $_dependentTables = array('Model_Step2Mp6');
	
	/**
	 * [createStep2Mp6Field7 create a new row in the mps_6_7 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep2Mp6Field7($id)
	{
