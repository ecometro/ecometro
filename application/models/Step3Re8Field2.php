<?php
/**
* Class Model for res_8_2 table
*/
class Model_Step3Re8Field2 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'res_8_2';	
	protected $_primary = 'id';	
	protected $_dependentTables = array('Model_Step3Re8');
	
	/**
	 * [createStep3Re8Field2 create a new row in the res_8_2 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep3Re8Field2($id)
	{
