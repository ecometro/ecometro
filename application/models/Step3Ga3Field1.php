<?php
/**
* Class Model for gas_3_1 table
*/
class Model_Step3Ga3Field1 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'gas_3_1';	
	protected $_primary = 'id';
	
	protected $_dependentTables = array('Model_Step3Ga3');
	
	/**
	 * [createStep3Ga3Field1 create a new row in the gas_3_1 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep3Ga3Field1($id)
	{
