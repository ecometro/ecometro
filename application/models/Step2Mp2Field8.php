<?php
/**
* Class Model for mps_2_8 table
*/
class Model_Step2Mp2Field8 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'mps_2_8';	
	protected $_primary = 'id';	
	protected $_dependentTables = array('Model_Step2Mp2');
	
	/**
	 * [createStep2Mp2Field8 create a new row in the mps_2_8 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep2Mp2Field8($id)
	{
