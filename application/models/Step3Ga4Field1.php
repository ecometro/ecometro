<?php
/**
* Class Model for gas_4_1 table
*/
class Model_Step3Ga4Field1 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'gas_4_1';	
	protected $_primary = 'id';
	
	protected $_dependentTables = array('Model_Step3Ga4');
	
	/**
	 * [createStep3Ga4Field1 create a new row in the gas_4_1 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep3Ga4Field1($id)
	{
