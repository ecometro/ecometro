<?php
/**
* Class Model for res_1_1 table
*/
class Model_Step3Re1Field1 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'res_1_1';	
	protected $_primary = 'id';
	
	protected $_dependentTables = array('Model_Step3Re1');
	
	protected $_referenceMap = array (
		'Calculus' => array(
		'columns' => array('id_calculus'),
		'refTableClass' => 'Model_Calculus'
	 	));
	
	/**
	 * [createStep3Re1Field1 create a new row in the res_1_1 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep3Re1Field1($id)
	{
