<?php
/**
* Class Model for bcs_1_1 table
*/
class Model_Step3Bc1Field1 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'bcs_1_1';	
	protected $_primary = 'id';
	
	protected $_dependentTables = array('Model_Step3Bc1');
	
	/**
	 * [createStep3Bc1Field1 create a new row in the bcs_1_1 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep3Bc1Field1($id)
	{
