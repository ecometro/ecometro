<?php
/**
* Class Model for bcs_7_4 table
*/
class Model_Step3Bc7Field4 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'bcs_7_4';	
	protected $_primary = 'id';
	
	protected $_dependentTables = array('Model_Step3Bc7');

	/**
	 * [createStep3Bc7Field4 create a new row in the bcs_7_4 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep3Bc7Field4($id)
	{
