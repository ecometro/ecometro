<?php
/**
* Class Model for bcs_6_4 table
*/
class Model_Step3Bc6Field4 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'bcs_6_4';	
	protected $_primary = 'id';
	
	protected $_dependentTables = array('Model_Step3Bc6');

	/**
	 * [createStep3Bc6Field4 create a new row in the bcs_6_4 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep3Bc6Field4($id)
	{
