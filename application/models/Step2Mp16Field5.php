<?php
/**
* Class Model for mps_16_5 table
*/
class Model_Step2Mp16Field5 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'mps_16_5';	
	protected $_primary = 'id';	
	protected $_dependentTables = array('Model_Step2Mp16');
		
	/**
	 * [createStep2Mp16Field5 create a new row in the mps_16_5 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep2Mp16Field5($id)
	{
