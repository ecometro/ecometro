<?php
/**
* Class Model for res_11_2 table
*/
class Model_Step3Re11Field2 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'res_11_2';	
	protected $_primary = 'id';
	
	protected $_dependentTables = array('Model_Step3Re11');
	
	/**
	 * [createStep3Re11Field2 create a new row in the res_11_2 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep3Re11Field2($id)
	{
