<?php
/**
* Class Model for gas_1_6 table
*/
class Model_Step3Ga1Field6 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'gas_1_6';	
	protected $_primary = 'id';
	
	protected $_dependentTables = array('Model_Step3Ga1');

	/**
	 * [createStep3Ga1Field6 create a new row in the gas_1_6 table	]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep3Ga1Field6($id)
	{
