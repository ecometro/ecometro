<?php
/**
* Class Model for mps_10_7 table
*/
class Model_Step2Mp10Field7 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'mps_10_7';	
	protected $_primary = 'id';		
	protected $_dependentTables = array('Model_Step2Mp10');

	/**
	 * [createStep2Mp10Field7 create a new row in the mps_10_7 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep2Mp10Field7($id)
	{
