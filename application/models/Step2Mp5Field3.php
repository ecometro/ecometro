<?php
/**
* Class Model for mps_5_3 table
*/
class Model_Step2Mp5Field3 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'mps_5_3';	
	protected $_primary = 'id';		
	protected $_dependentTables = array('Model_Step2Mp5');
	
	/**
	 * [createStep2Mp5Field3 create a new row in the mps_5_3 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep2Mp5Field3($id)
	{
