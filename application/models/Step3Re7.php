<?php
/**
* Class Model for s_3_res_7 table
*/
class Model_Step3Re7 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 's_3_res_7';	
	protected $_primary = 'id';
	
	protected $_dependentTables = array('Model_Step3');
	
	protected $_referenceMap = array(
		'Step3Re7Field1' => array(
			'columns' => array('re_7_1_id'),
			'refTableClass' => 'Model_Step3Re7Field1'
	 	),
	 	'Step3Re7Field2' => array(
			'columns' => array('re_7_2_id'),
			'refTableClass' => 'Model_Step3Re7Field2'
	 	)
	);

	/**
	 * [createStep3Re7 create a new row in the s_3_res_7 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep3Re7($id)
	{
	...
	/**
	 * [updateStep3Re7 update table s_3_res_7's row]
	 * @param  [type] $id        [description]
	 * @param  [type] $idStep3Re [description]
	 * @param  [type] $count     [description]
	 * @return [type]            [description]
	 */
	public function updateStep3Re7($id, $idStep3Re, $count)
	{
	...
	/**
	 * [findFieldbyRe7Id find field number by s_3_res_7's id]
	 * @param  [type] $re7Id [description]
	 * @param  [type] $count [description]
	 * @return [type]        [description]
	 */
	public function findFieldbyRe7Id($re7Id, $count)
	{
		$result = $re7Id->findParentRow('Model_Step3Re7Field' . $count);
