<?php
/**
* Class Model for res_1_2 table
*/
class Model_Step3Re1Field2 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'res_1_2';	
	protected $_primary = 'id';
	
	protected $_dependentTables = array('Model_Step3Re1', 'Model_Calculus');
	
	/**
	 * [createStep3Re1Field2 create a new row in the res_1_2 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep3Re1Field2($id)
	{
