<?php
/**
* Class Model for mps_14_1 table
*/
class Model_Step2Mp14Field1 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'mps_14_1';	
	protected $_primary = 'id';	
	protected $_dependentTables = array('Model_Step2Mp14');
		
	/**
	 * [createStep2Mp14Field1 create a new row in the mps_14_1 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep2Mp14Field1($id)
	{
