<?php
/**
* Class Model for bls_2_4 table
*/
class Model_Step3Bl2Field4 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'bls_2_4';	
	protected $_primary = 'id';
	
	protected $_dependentTables = array('Model_Step3Bl2');

	/**
	 * [createStep3Bl2Field4 create a new row in the bls_2_4 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep3Bl2Field4($id)
	{
