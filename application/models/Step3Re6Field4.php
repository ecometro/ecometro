<?php
/**
* Class Model for res_6_4 table
*/
class Model_Step3Re6Field4 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'res_6_4';	
	protected $_primary = 'id';
	
	protected $_dependentTables = array('Model_Step3Re6');
	
	/**
	 * [createStep3Re6Field4 create a new row in the res_6_4 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep3Re6Field4($id)
	{
