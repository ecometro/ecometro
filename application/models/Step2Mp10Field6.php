<?php
/**
* Class Model for mps_10_6 table
*/
class Model_Step2Mp10Field6 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'mps_10_6';	
	protected $_primary = 'id';		
	protected $_dependentTables = array('Model_Step2Mp10');

	/**
	 * [createStep2Mp10Field6 create a new row in the mps_10_6 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep2Mp10Field6($id)
	{
