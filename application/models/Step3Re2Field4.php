<?php
/**
* Class Model for res_2_4 table
*/
class Model_Step3Re2Field4 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'res_2_4';	
	protected $_primary = 'id';
	
	protected $_dependentTables = array('Model_Step3Re2');

	/**
	 * [createStep3Re2Field4 create a new row in the res_2_4 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep3Re2Field4($id)
	{
