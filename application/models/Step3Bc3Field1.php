<?php
/**
* Class Model for bcs_3_1 table
*/
class Model_Step3Bc3Field1 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'bcs_3_1';	
	protected $_primary = 'id';
	
	protected $_dependentTables = array('Model_Step3Bc3');
	
	/**
	 * [createStep3Bc3Field1 create a new row in the bcs_3_1 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep3Bc3Field1($id)
	{
