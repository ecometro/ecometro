<?php
/**
* Class Model for mps_3_1 table
*/
class Model_Step2Mp3Field1 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'mps_3_1';	
	protected $_primary = 'id';	
	protected $_dependentTables = array('Model_Step2Mp3');
	
	/**
	* [createStep2Mp3Field1 create a new row in the mps_3_1 table]
	*/
	public function createStep2Mp3Field1($id)
	{
