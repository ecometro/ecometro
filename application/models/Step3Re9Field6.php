<?php
/**
* Class Model for res_9_6 table
*/
class Model_Step3Re9Field6 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'res_9_6';	
	protected $_primary = 'id';
	
	protected $_dependentTables = array('Model_Step3Re9');

	/**
	 * [createStep3Re9Field6 create a new row in the res_9_6 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep3Re9Field6($id)
	{
