<?php
/**
* Class Model for mps_6_1 table
*/
class Model_Step2Mp6Field1 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'mps_6_1';	
	protected $_primary = 'id';	
	
	protected $_dependentTables = array('Model_Step2Mp6');
	
	/**
	 * [createStep2Mp6Field1 create a new row in the mps_6_1 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep2Mp6Field1($id)
	{
