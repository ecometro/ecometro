<?php
/**
* Class Model for mps_5_4 table
*/
class Model_Step2Mp5Field4 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'mps_5_4';	
	protected $_primary = 'id';		
	protected $_dependentTables = array('Model_Step2Mp5');
	
	/**
	 * [createStep2Mp5Field4 create a new row in the mps_5_4 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep2Mp5Field4($id)
	{
