<?php
/**
* Class Model for mps_8_3 table
*/
class Model_Step2Mp8Field3 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'mps_8_3';	
	protected $_primary = 'id';	
	
	protected $_dependentTables = array('Model_Step2Mp8');
	
	/**
	 * [createStep2Mp8Field3 create a new row in the mps_8_2 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep2Mp8Field3($id)
	{
