<?php
/**
* Class Model for bcs_2_3 table
*/
class Model_Step3Bc2Field3 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'bcs_2_3';	
	protected $_primary = 'id';
	
	protected $_dependentTables = array('Model_Step3Bc2');

	/**
	 * [createStep3Bc2Field3 create a new row in the bcs_2_3 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep3Bc2Field3($id)
	{
