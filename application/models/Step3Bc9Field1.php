<?php
/**
* Class Model for bcs_9_1 table
*/
class Model_Step3Bc9Field1 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'bcs_9_1';	
	protected $_primary = 'id';
	
	protected $_dependentTables = array('Model_Step3Bc9');

	/**
	 * [createStep3Bc9Field1 create a new row in the bcs_9_1 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep3Bc9Field1($id)
	{
