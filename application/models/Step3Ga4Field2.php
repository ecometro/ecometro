<?php
/**
* Class Model for gas_4_2 table
*/
class Model_Step3Ga4Field2 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'gas_4_2';	
	protected $_primary = 'id';
	
	protected $_dependentTables = array('Model_Step3Ga4');
	
	/**
	 * [createStep3Ga4Field2 create a new row in the gas_4_2 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep3Ga4Field2($id)
	{
