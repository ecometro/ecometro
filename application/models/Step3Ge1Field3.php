<?php
/**
* Class Model for ges_1_3 table
*/
class Model_Step3Ge1Field3 extends Zend_Db_Table_Abstract
{
	
	protected $_name = 'ges_1_3';	
	protected $_primary = 'id';
	
	protected $_dependentTables = array('Model_Step3Ge1');
	
	/**
	 * [createStep3Ge1Field3 create a new row in the ges_1_3 table]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function createStep3Ge1Field3($id)
	{
