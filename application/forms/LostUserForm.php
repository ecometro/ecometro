...
*/
 class Form_LostUserForm extends Zend_Form
 {
 	/**
	* Documentation Block Here
	*/
 	public function init()
 	{
		...
		$user_user_lost = $this->createElement('text', 'user_email_lost');
		$user_user_lost->setLabel(Zend_Registry::get('Zend_Translate')->translate('Correo electrónico'))
						->setRequired(true)
						->addValidators(array(
		...
		$this->addElement($user_user_lost);	
		...
		$user_submit_lost->setLabel(Zend_Registry::get('Zend_Translate')->translate('Recordar usuario'))
						->setAttrib('class', 'boton black')
						->removeDecorator('DtDdWrapper');
		$this->addElement($user_submit_lost);
		
		// establish the register form view
		$this->setDecorators(array(array('ViewScript',array('viewScript' => 'forms/_form_lost_user.phtml'))));
 	}
 }